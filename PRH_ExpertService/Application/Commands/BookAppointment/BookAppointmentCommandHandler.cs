...
//                var expertProfile = await expertAvailabilityRepository.GetByIdAsync(availability.ExpertProfileId);
...
//                response.Data = qrCodeLink; // Đường dẫn QR Code để người dùng thanh toán
